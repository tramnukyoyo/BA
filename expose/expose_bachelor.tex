...
Regionale HRS-Strategien unterscheiden sich erheblich:
...
\begin{itemize}
  ...
  \item \textbf{Australien:} Mit reichlich vorhandener erneuerbarer Energie und geografischer Nähe zu asiatischen Märkten entwickelt sich eine HRS-Industrie als Drehscheibe für H\textsubscript{2}-Versorgung zu Japan und Korea.
\end{itemize}

\subsection*{Kostenstruktur und Wirtschaftlichkeit von HRS}

Die wirtschaftliche Rentabilität von Wasserstofftankstellen hängt stark von Standort, Stationsgröße und Auslastung ab. Kostenanalysen zeigen für 35-MPa-HRS (heute Standard) Investitionskosten (CAPEX) von €500k bis €2M pro Station, abhängig von regionalen Faktoren und Technik. Die Betriebskosten (OPEX) betragen €50k-€200k/Jahr, inklusive Wartung, Personal und Wasserstoff-Lieferkosten. Wasserstoff-Kosten liegen derzeit bei €7-12/kg grün (abhängig von Stromkosten), müssen aber bis 2030 auf €2-3/kg sinken für Rentabilität ohne Subventionen \cite{Chung2024, Eissler2023}. Bei typischen Auslastungsszenarien (30--80\%) zeigen ökonomische Modelle, dass 58\% Subventionen erforderlich sind für Break-Even-Profitabilität \cite{Vizza2025}. Diese Variation erfordert regionsabhängige Strategien und differenzierte Finanzierungsmechanismen.
...
\begin{enumerate}
  ...
  \begin{itemize}
    \item Supply-Chain-Integration von H\textsubscript{2}-Produktion zu Endnutzer
    ...
    \item Räumliche Optimierung und Standortwahl für HRS
  \end{itemize}
...
\begin{enumerate}
  ...
  \begin{itemize}
    \item Dimension 1: Regulatorische Hürden (Standards, Zertifizierung, nationale Regelwerke)
    \item Dimension 2: Logistische Hürden (Versorgungskette, Transport, Speicherung)
    \item Dimension 3: Technische Hürden (Zuverlässigkeit, Wartung, Skalierung)
    \item Anwendung auf 3 Regionen: Europa, Asien-Pazifik, Australien
  \end{itemize}
  \item[3.3] Szenarioentwicklung: HRS-Integrationsszenarien
  \begin{itemize}
    \item Szenario A: Korridor-basiert (Highway-Deployment, TEN-T-Modell)
    \item Szenario B: Urbane Cluster (Stadtnahe HRS-Netzwerke)
    \item Szenario C: Industrie-Hubs (Hafen- und Logistikzentren)
    \item Versorgungslogistik-Varianten pro Szenario
  \end{itemize}
  \item[3.4] Cost-Benefit-Analysis (CBA) Modell
  \begin{itemize}
    \item NPV-Berechnung mit 10-20 Jahre Zeithorizont
    \item Kostendisaggregation: CAPEX (Stationen, Speicherung), OPEX (Wartung, Personal), H\textsubscript{2}-Kosten, Transport
